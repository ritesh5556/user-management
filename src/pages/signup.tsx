      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="max-w-md w-full">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600">Join us today and get started with your journey</p>
          </div>
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-indigo-600 flex-col justify-center items-center p-12 text-white">
        <div className="max-w-md">
          ...
          <p className="text-indigo-100 mb-8">
            Create an account to get started and unlock all the features our platform has to offer.
          </p>
